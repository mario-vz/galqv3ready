...
export const EditReservationModal = ({ isOpen, onClose, onSuccess, reservation }: EditReservationModalProps) => {
  ...
  const [existingReservations, setExistingReservations] = useState<Array<{check_in: string, check_out: string, id: string}>>([]);
  ...
  const [formData, setFormData] = useState({
    ...
    source: reservation.source || 'Airbnb',
  ...
  const translations = {
    es: {
      ...
      dateConflict: 'Las fechas seleccionadas tienen conflicto con otras reservas',
      blockedDatesInfo: 'Las fechas ocupadas aparecen deshabilitadas',
      existingReservations: 'Otras reservas',
    },
    gl: {
      title: 'Editar Reserva',
      property: 'Propiedade',
      ...
      dateConflict: 'As datas seleccionadas teñen conflito con outras reservas',
      blockedDatesInfo: 'As datas ocupadas aparecen deshabilitadas',
      existingReservations: 'Outras reservas',
    },
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="bg-soft-mint p-4 rounded-lg">
            ...
            <p className="font-semibold text-atlantic-blue">{reservation.properties.name}</p>
          </div>
